...
const Footer: React.FC = () => {
  ...
  const { styles, attributes} = usePopper(referenceElement.current,
    ...
    <footer className="footer">
      <div className="footer__center">
        ...
        <div className="footer-right">
          ...
          <div onClick={()=>setOpen(false)} className="footer-right-copyInfo" ref={popperElement} style={styles.popper} {...attributes.popper}>
